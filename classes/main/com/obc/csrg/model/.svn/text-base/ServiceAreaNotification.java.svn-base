...
@Entity
@Name("serviceAreaNotification")
@Scope(SESSION)
@Table(name = "service_area_notification")
//@org.hibernate.annotations.Cache(usage = CacheConcurrencyStrategy.TRANSACTIONAL)
public class ServiceAreaNotification extends Model implements
		Serializable {

	@SequenceGenerator(name = "generator")
	@Id
	@GeneratedValue(strategy = SEQUENCE, generator = "generator")
	@Column(name = "serv_area_notif_id", nullable = false)
	private Long id;
	...
	// constructors
	public ServiceAreaNotification() {
	}
	...
	public boolean remove(EntityManager entityManager) {
		...
		this.serviceArea.getNotifications().remove(this);
		this.serviceArea = null;
		if(this.notification!=null){
			this.notification.getServiceAreas().remove(this);
			this.notification = null;
		}
		if(this.news!=null){
			this.news.getServiceAreas().remove(this);
			this.news = null;
		}
		if(this.visualItem!=null){
			this.visualItem.getServiceAreas().remove(this);
			this.visualItem=null;
		}
		if(this.composedNotification!=null){
			this.composedNotification.getServiceAreas().remove(this);
	...
	public boolean equals(Object object) {
		if (object instanceof ServiceAreaNotification) {
			final ServiceAreaNotification obj = (ServiceAreaNotification) object;
