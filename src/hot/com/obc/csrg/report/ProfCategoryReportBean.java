...
import com.obc.csrg.local.report.ProfCategoryReportBeanLocal;
import com.obc.csrg.model.Model;
import com.obc.csrg.model.ProfCategory;
import com.obc.csrg.util.ReportFilter;

@Name("profCategoryReport")
@Stateful
@Scope(ScopeType.SESSION)
public class ProfCategoryReportBean extends ReportBean<ProfCategory> implements ProfCategoryReportBeanLocal{
	...
	@Override
	public String query(){
		this.setBaseClassname("ProfCategory");
