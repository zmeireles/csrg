...
import com.obc.csrg.local.StyleBeanLocal;
//import com.obc.csrg.icefaces.NavigationNames;
...
public class StyleBean implements StyleBeanLocal,Serializable {
    ...
    public StyleBean() {
    	...
    	//log.info("[StyleBean] initialization");
        ...
        styleMap.put(RIME, new StylePath(
                "/stylesheet/rime/rime.css",
                "/stylesheet/rime/css-images/"));
        
        styleMap.put(XP, new StylePath(
                "/stylesheet/xp/xp.css",
                "/stylesheet/xp/css-images/"));
        styleMap.put(ROYALE, new StylePath(
                "/stylesheet/css/royale/royale.css",
                "/stylesheet/royale/css-images/"));
    }
    ...
    public String getImageDirectory() {
    	//log.info("[getImageDirectory] currentStyle:#0 result:#1", currentStyle,((StylePath)styleMap.get(currentStyle)).imageDirPath);
    	
    	
        return ((StylePath)styleMap.get(currentStyle)).imageDirPath;
    }
    public String getImageLink(){
    	//log.info("[getImageLink] currentStyle:#0 result:#1", currentStyle,((StylePath)styleMap.get(currentStyle)).imageDirPath);
    	return "/csrg" + ((StylePath)styleMap.get(currentStyle)).imageDirPath;
    }
